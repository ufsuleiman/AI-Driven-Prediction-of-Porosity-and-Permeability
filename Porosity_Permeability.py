...
poro_file = 'Porosity_Preprocessed_Data.xlsx'         # Porosity Preprocessed Features
perm_file = 'Permeability_Preprocessed_Data.xlsx'    # Permeability Preprocessed Features

poro_features = ['RHOB','NPHI','DT','GR','PEF','CALI','DRHO']    # porosity inputs
perm_features = ['RHOB','NPHI','DT','GR','PEF','CALI','DRHO','RD','RM','RT']  # permeability inputs
...
def train_mlp_with_history(X, y, hidden_layers, model_name="model",
    ...
    # MLPRegressor with warm_start=True and max_iter=1 to iterate epochs manually
...
def run_baseline_all():
    ...
    # reverse transforming if needed for reporting
    ...
    # ploting permeability training history
    ...
    # perm test scatter: use original units if log transformed
